...
```
conda install git nodejs xlwings wxyz_core wxyz_lab ipydrawio ipydrawio-export papermill jupyter_kernel_gateway -y && pip install jupyterlab==3.0.17 elyra && jupyter labextension install @j123npm/qgrid2@1.1.4 && jupyter lab build
```
